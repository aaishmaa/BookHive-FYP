...
import {
  ArrowLeftRight, Search, Heart, MessageCircle,
  Share2, Bookmark, ChevronDown, Lightbulb,
...
const EXCHANGE_BOOKS = [
  { id: 1,  seller: "Ravi Kumar",   si: "R", time: "1 day ago",    badge: "Fair",       title: "Engineering Mathematics",    author: "by B.S. Grewal",         likes: 32, comments: 8, img: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=700&h=380&fit=crop" },
  { id: 2,  seller: "Ananya Das",   si: "A", time: "12 hours ago", badge: "Acceptable", title: "Microeconomics Theory",      author: "by Hal Varian",          likes: 9,  comments: 1, img: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=700&h=380&fit=crop" },
  { id: 3,  seller: "Divya Reddy",  si: "D", time: "2 days ago",   badge: "Fair",       title: "Financial Accounting",       author: "by R.L. Gupta",          likes: 5,  comments: 1, img: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=700&h=380&fit=crop" },
  { id: 4,  seller: "Meera Nair",   si: "M", time: "3 days ago",   badge: "Good",       title: "Principles of Management",   author: "by Harold Koontz",       likes: 14, comments: 3, img: "https://images.unsplash.com/photo-1568667256549-094345857637?w=700&h=380&fit=crop" },
  { id: 5,  seller: "Karan Singh",  si: "K", time: "5 days ago",   badge: "Acceptable", title: "Environmental Engineering",  author: "by De & Bhattacharya",   likes: 7,  comments: 2, img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=700&h=380&fit=crop" },
  { id: 6,  seller: "Sneha Iyer",   si: "S", time: "4 days ago",   badge: "Fair",       title: "Human Resource Management",  author: "by Gary Dessler",        likes: 11, comments: 4, img: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=700&h=380&fit=crop" },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-3">
        ...
        <span className="text-[11.5px] font-medium px-3 py-1 rounded-full bg-emerald-50 text-emerald-600">
          Exchange
        </span>
      </div>
      ...
      <div className="px-4 pt-3 pb-4">
        ...
        <div className="flex items-center justify-between">
          <span className="text-[15px] font-extrabold text-[#1C7C84]">For Exchange</span>
    ...
    <div className="flex h-full overflow-hidden bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        ...
        >
          ...
          <div>
            <h1 className="text-[22px] font-bold text-gray-900 leading-tight">Exchange Books</h1>
            <p className="text-[13px] text-gray-400">Swap books with fellow students</p>
          </div>
        </motion.div>
        ...
        <div className="flex items-center gap-3 mb-5 flex-wrap">
          {["All Categories", "Newest"].map((label) => (
        ...
        <motion.div
          ...
          className="flex items-center gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-6 max-w-2xl"
        >
          <Lightbulb className="w-4 h-4 text-amber-500 shrink-0" />
          <p className="text-[13px] text-amber-700">
            <span className="font-semibold">Tip:</span> Exchange works best when you list your own books too!{" "}
            <button
              onClick={() => navigate("/upload")}
              className="text-[#1C7C84] font-semibold underline hover:no-underline"
            >
              Upload a book
            </button>{" "}
            to start swapping.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-5 pb-8">
          ...
          {filtered.length === 0 && (
            <div className="col-span-full text-center py-20 text-gray-400">
              ...
              <p className="text-sm font-medium">No exchange books found</p>
            </div>
          )}
        </div>
      </div>
