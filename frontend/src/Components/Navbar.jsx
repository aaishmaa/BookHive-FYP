...
const Navbar = () => {
  ...
  // Clear search when leaving home/browse pages
  useEffect(() => {
  ...
  // Navigate to home when user starts searching (if not already on a searchable page)
  ...
  return (
    <nav className="bg-white border-b border-gray-200 px-6 h-[60px] flex items-center justify-between shrink-0 z-50 sticky top-0">
      ...
      <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-2 w-[420px] max-w-[38vw] focus-within:border-[#1C7C84] transition">
        ...
        {inputVal && (
          <button
            onClick={() => { setInputVal(""); setSearchQuery(""); }}
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          ...
          className="ml-1 w-8 h-8 rounded-full bg-[#D1E8EA] border border-[#1C7C84]/20 flex items-center justify-center hover:bg-[#1C7C84]/20 transition"
        >
          {initials
